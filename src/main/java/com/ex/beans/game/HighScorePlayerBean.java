...
//@GeneratedValue(generator="U_SEQ_GEN", strategy=GenerationType.SEQUENCE)
	...
	public void setUsername(StringBuffer stringBuffer) {
		this.username = stringBuffer;
	}
	public int getScore() {
		return score;
	}
	...
	public HighScorePlayerBean(StringBuffer username, int score, int max_streak, int number_correct) {
		super();
